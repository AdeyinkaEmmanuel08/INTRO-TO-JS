...
function reverse(animal) {
  return animal.split("").reverse().join();
  // return animal.reverse();
}
console.log(reverse(animal));
// function extract_from_string(str, start_index, num) {
//   if (!str) return "";

//   return str.slice(start_index, start_index + num);
// }

// // Test Data
// console.log(extract_from_string("Robin Singh", 6, 4));
...
// // Slice from the start index up to (start_index + how many characters you want)
// // Output: "Sing"
